...
CREATE TABLE `films` (
  ...
  `director` varchar(30) CHARACTER SET latin1 NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`),
  KEY `id_2` (`id`)
...
INSERT INTO `films` VALUES (1,'Karabinol','2000','rus','rap','john'),(2,'2','2015','USA','trash','Tarantino Quentin'),(5,'dfghjk','1234','xcvb','xcv','fghj');
...
-- Dump completed on 2015-04-07 15:40:19
